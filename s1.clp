...
(deffacts Linda
	...
	(le cadavre a une relation hostile avec Denis)
	(le cadavre a une relation neutre avec Jean-Guy)
)

(deffacts Marc
	(la personne Marc est profession Flight-attendant)
	(La personne Marc a deja commis un crime)
	(La personne Marc est une personne derange)
	(la personne Marc est au lieu aeroport)
	(La personne Marc possede dans son compte de banque entre 50000 et 75000)
	(La personne Marc a été vu a 15 h)
)

(deffacts Denis
	(la personne Denis est profession Bartender)
	(La personne Denis a deja commis un crime)
	(La personne Denis est une personne bon)
	(la personne Denis est au lieu hotel)
	(La personne Denis possede dans son compte de banque entre 25000 et 50000)
	(La personne Denis a été vu a 21 h)
)
